<section class="py-5">
    <div class="container">
        <h1 class="mb-4">Search Results for "
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            <a href="<?php echo getSortURL('name', $sort, $order); ?>"
                                class="btn btn-sm <?php echo ($sort == 'name') ? 'btn-primary' : 'btn-outline-secondary'; ?>">
                                Name
                                <?php echo getSortIcon('name', $sort, $order); ?>
                            </a>
                            <a href="<?php echo getSortURL('price', $sort, $order); ?>"
                                class="btn btn-sm <?php echo ($sort == 'price') ? 'btn-primary' : 'btn-outline-secondary'; ?>">
                                Price
                                <?php echo getSortIcon('price', $sort, $order); ?>
                            </a>
                            <a href="<?php echo getSortURL('id', $sort, $order); ?>"
                                class="btn btn-sm <?php echo ($sort == 'id') ? 'btn-primary' : 'btn-outline-secondary'; ?>">
                                Newest
                                <?php echo getSortIcon('id', $sort, $order); ?>
                            </a>
                            <div style="align-items: end;justify-content: end;" class="ms-3">
                                <form role="search" action="<?php echo SITE_URL; ?>products/search" method="get">
                                    <div class="row g-2">
                                        <div class="col-md-1">
                                            <div class="input-group" hidden>
                                                <input class="form-control search-input dynamic-search-input"
                    ...
                    <div id="dynamic-search-results">
                        ...
                        <div class="product-container d-flex flex-wrap">
                            ...
                            <div class="product-col">
                                <a href="<?php echo SITE_URL; ?>products/detail/<?php echo $product['id']; ?>"
                            ...
                            <nav aria-label="Page navigation" class="mt-4">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <li class="page-item <?php echo ($page <= 1) ? 'disabled' : ''; ?>">
                                        <a class="page-link"
                                            href="<?php echo getPaginationURL($page - 1); ?>">Previous</a>
                                    </li>
                        ...
                        <div class="alert alert-info">
                            ...
                            <hr>
                            <p class="mb-0">Try using different keywords or check out our <a
                                    href="<?php echo SITE_URL; ?>products">product catalog</a>.</p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
