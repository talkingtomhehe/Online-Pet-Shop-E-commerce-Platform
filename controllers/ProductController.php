...
class ProductController {
    ...
    public function index() {
        ...
        // Get products
        $products = $this->productModel->getAllProducts($sort, $order, $limit, $offset, $minPrice, $maxPrice);
        $totalProducts = $this->productModel->countProducts($minPrice, $maxPrice);
    ...
    public function category($categoryName) {
        ...
        if ($category) {
            ...
            // CHANGE THESE TWO LINES:
            // Instead of using category name, use category ID
            $products = $this->productModel->getProductsByCategory($category['id'], $sort, $order, $limit, $offset, $minPrice, $maxPrice);
            $totalProducts = $this->productModel->countProductsByCategory($category['id'], $minPrice, $maxPrice);
            $totalPages = ceil($totalProducts / $limit);
    ...
    public function search() {
        ...
        if (!empty($search)) {
            ...
            // 2. Update these two lines to use the new methods and variables
            $products = $this->productModel->searchProducts($search, $sort, $order, $limit, $offset, $minPrice, $maxPrice);
            $totalProducts = $this->productModel->countSearchProducts($search, $minPrice, $maxPrice);
