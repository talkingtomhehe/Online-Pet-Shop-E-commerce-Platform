...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 03, 2025 lúc 05:49 PM
...
(4, 1, 1, 1, '2025-11-27', '10:30:00', 'completed', 'I will be there.', '2025-11-26 11:35:14', '2025-12-03 09:34:04'),
(5, 1, 4, 1, '2025-12-03', '10:00:00', 'completed', '', '2025-12-02 10:35:25', '2025-12-03 10:34:24'),
(8, 1, 4, 1, '2025-12-04', '10:00:00', 'cancelled', 'Hello', '2025-12-03 16:44:17', '2025-12-03 16:45:27'),
(9, 1, 4, 1, '2025-12-04', '10:00:00', 'completed', '', '2025-12-03 16:48:29', '2025-12-03 16:48:46');
...
(7, 1, 'Your Order #8 status has been updated.', 'http://localhost/onlinepetshop/user/order-detail/8', 1, '2025-12-03 09:32:22'),
(8, 1, 'Your Spa Appointment #6 is now Cancelled', 'http://localhost/onlinepetshop/index.php?page=user-appointments', 1, '2025-12-03 09:32:39'),
(9, 1, 'Your Spa Appointment #6 is now Cancelled', 'http://localhost/onlinepetshop/index.php?page=user-appointments', 1, '2025-12-03 09:32:54'),
(10, 1, 'Your Pet Spa booking #7 has been placed successfully.', 'index.php?page=user-appointments', 1, '2025-12-03 09:33:44'),
(11, 1, 'Your Spa Appointment #4 is now Completed', 'http://localhost/onlinepetshop/index.php?page=user-appointments', 1, '2025-12-03 09:34:04'),
(12, 1, 'Your Spa Appointment #7 is now Confirmed', 'http://localhost/onlinepetshop/index.php?page=user-appointments', 1, '2025-12-03 09:43:22'),
(13, 1, 'Your Spa Appointment #5 is now Completed', 'http://localhost/onlinepetshop/index.php?page=user-appointments', 1, '2025-12-03 10:34:24'),
(14, 1, 'Order has been placed successfully!', 'index.php?page=user&action=order-detail&id=9', 1, '2025-12-03 16:41:17'),
(15, 1, 'Your Order #9 status has been updated.', 'http://localhost/onlinepetshop/user/order-detail/9', 1, '2025-12-03 16:42:02'),
(16, 1, 'Your Order #9 status has been updated.', 'http://localhost/onlinepetshop/user/order-detail/9', 1, '2025-12-03 16:43:31'),
(17, 1, 'Your Pet Spa booking #8 has been placed successfully.', 'index.php?page=user-appointments', 1, '2025-12-03 16:44:17'),
(18, 1, 'Your Spa Appointment #8 is now Confirmed', 'http://localhost/onlinepetshop/index.php?page=user-appointments', 1, '2025-12-03 16:44:38'),
(19, 1, 'Your Spa Appointment #8 is now Cancelled', 'http://localhost/onlinepetshop/index.php?page=user-appointments', 1, '2025-12-03 16:45:27'),
(20, 1, 'Your Pet Spa booking #9 has been placed successfully.', 'index.php?page=user-appointments', 1, '2025-12-03 16:48:29'),
(21, 1, 'Your Spa Appointment #9 is now Confirmed', 'http://localhost/onlinepetshop/index.php?page=user-appointments', 1, '2025-12-03 16:48:41'),
(22, 1, 'Your Spa Appointment #9 is now Completed', 'http://localhost/onlinepetshop/index.php?page=user-appointments', 1, '2025-12-03 16:48:46');
...
(6, 1, 'user1 nguyen', 'user1@gmail.com', '68/2A', 'tphcm', '1112', '32434324', 91.98, 'cancelled', NULL, '2025-12-02 10:29:35', '2025-12-02 10:37:10'),
(7, 1, 'user1 nguyen', 'user1@gmail.com', '68/2A', 'tphcm', '1112', '32434324', 45.99, 'shipped', NULL, '2025-12-02 10:32:49', '2025-12-03 08:56:23'),
(8, 1, 'user1 nguyen', 'user1@gmail.com', '68/2A', 'tphcm', '1112', '32434324', 99.99, 'processing', NULL, '2025-12-03 09:31:19', '2025-12-03 09:32:22'),
(9, 1, 'user1 nguyen', 'user1@gmail.com', '68/2A', 'tphcm', '1112', '32434324', 40.00, 'delivered', NULL, '2025-12-03 16:41:17', '2025-12-03 16:43:31');
...
(3, 'KEOS Dog Kibble 1.5kg Bag - Keos+ Digestive Support with Beef and Chicken Flavor', 'High-quality dog kibble designed to support digestive health.', 45.99, 'public\\images\\keos.jpg', 4, 0, 1),
...
(8, 'Smartheart 400g - Grilled Beef Flavor Adult Dog Food - Thailand', 'Specially formulated for adult dogs with a delicious grilled beef flavor.', 11.99, 'public\\images\\smartheart.jpg', 5, 0, 1),
...
INSERT INTO `spa_services` (`id`, `name`, `duration_minutes`, `price`, `description`, `is_active`, `created_at`) VALUES
(1, 'Full Grooming', 30, 75.00, 'Complete grooming package including bath, haircut, nail trim, and ear cleaning', 1, '2025-11-26 10:38:31'),
(2, 'Bath & Brush', 30, 35.00, 'Refreshing bath with premium shampoo and thorough brushing', 1, '2025-11-26 10:38:31'),
(3, 'Nail Trim & Paw Care', 30, 20.00, 'Professional nail trimming and paw pad care', 1, '2025-11-26 10:38:31'),
(4, 'Teeth Cleaning', 30, 50.00, 'Professional dental cleaning for fresh breath and healthy teeth', 1, '2025-11-26 10:38:31'),
(5, 'De-Shedding Treatment', 30, 45.00, 'Special treatment to reduce shedding and promote healthy coat', 1, '2025-11-26 10:38:31'),
(6, 'Luxury Spa Package', 30, 120.00, 'Premium spa experience with bath, massage, aromatherapy, and full grooming', 1, '2025-11-26 10:38:31'),
(7, 'Puppy First Groom', 30, 40.00, 'Gentle introduction to grooming for puppies under 6 months', 1, '2025-11-26 10:38:31'),
(8, 'Flea & Tick Treatment', 30, 55.00, 'Specialized bath and treatment for flea and tick removal', 1, '2025-11-26 10:38:31');
...
(1, 'Sarah Johnson', 'Senior Groomer', 1, '2025-11-26 10:38:31'),
(2, 'Mike Chen', 'Grooming Specialist', 1, '2025-11-26 10:38:31'),
(3, 'Emily Rodriguez', 'Spa Technician', 1, '2025-11-26 10:38:31'),
(4, 'David Kim', 'Pet Stylist', 1, '2025-11-26 10:38:31'),
(5, 'Lisa Thompson', 'Grooming Assistant', 1, '2025-11-26 10:38:31');
...
(1, 'user1', 'user1@gmail.com', '$2y$10$2MzpotsMrUbSAx5TYkMfQufy7IRwBubWIlI4g/ZCfrbnNqzyvVcAC', '2025-04-04 21:49:36', 'user1 nguyen', '32434324', '68/2A', 'tphcm', '1112', '2025-12-03 16:49:33', NULL, '2025-12-03 16:49:33', '2025-12-03 08:55:32', 'public/images/avatars/avatar_1_67f1c09bb795b.jpg', NULL, NULL, NULL),
...
ALTER TABLE `appointments`
  ...
  ADD CONSTRAINT `appointments_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `spa_services` (`id`) ON DELETE CASCADE,
